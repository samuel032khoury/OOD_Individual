...
/**
 * To demonstrate an English Solitaire board, whose dimension can be customized and always has an
 * empty slot (also customizable) allowed players to start the game.
 */
public class EnglishSolitaireModel implements MarbleSolitaireModel {
   ...
   * the "from positions" and the "jump over positions" have a marble, with the "to positions" are
   * empty.
   *
